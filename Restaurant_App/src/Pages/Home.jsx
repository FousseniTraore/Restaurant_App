    ...
    <div className='lg:px-30 sm:px-16 px-10'>
      <div className='py-10'>
        ...
        <div className="isolate bg-white px-6 py-24 sm:py-32 lg:px-8 bg-hero-pattern bg-cover rounded ">
          <h1 className="max-w-2xl mb-4 text-4xl font-extrabold tracking-tight leading-none md:text-5xl xl:text-6xl text-white">Search for your favorite restaurant</h1>
