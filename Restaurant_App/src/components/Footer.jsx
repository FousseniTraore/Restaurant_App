    ...
    <footer className='w-full bg-black'>
        <div className=' px-10 flex flex-col justify-center items-center   text-white md:flex-row md:gap-20'>
          ...
          <div className='md:px-40'>
            ...
            <div>
            <ul className='flex flex-row gap-x-5 py-5'>
              <a href="" aria-label="Find us on LinkedIn"
                target="_blank" rel="noopener">
                <svg className="h-5 w-5 text-white" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path
              ...
              <a href="" aria-label="Find us on Twitter" target="_blank" rel="noopener">
                <svg className="h-5 w-5 text-white" viewBox="0 0 48 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path
